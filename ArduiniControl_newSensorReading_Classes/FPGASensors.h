...
enum sensorsFloat {ACCELERATION, SPEEDHL, SPEEDVL, SPEEDHR, SPEEDVR};
#define SENSORARRAYSIZE 12
#define FPGACLOCKFREQUENCY 1000000
#define DELTAPHI 0.5236
...
public:
  ...
  static float doFloatingCalculation(const unsigned int type, const unsigned int data);
